 ...
 * @author ACER
 */
@WebServlet(name = "DeleteFreshFlower", urlPatterns = {"/DeleteFreshFlower"})
public class DeleteFreshFlower extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            utx.begin();
            boolean success = itemService.deleteItem(name);
            utx.commit();
